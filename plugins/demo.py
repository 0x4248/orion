...
# -- example menu registration for the demo plugin --
from orion.core.menu import manager as menu_manager

_m = menu_manager.register("demo", title="Demo Menu")
menu_manager.append_entry("demo", "hello", "Say Hello", kind="command", target="hello")
menu_manager.append_entry("demo", "both_plus", "Both+ (run)", kind="command", target="both_plus")
menu_manager.append_entry("demo", "uionly", "Open UI-only page", kind="command", target="uionly")
menu_manager.append_entry("demo", "external", "Orion site", kind="link", target="https://example.com")
